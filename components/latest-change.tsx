...
const latestChange = {
	badge: "UPDATE",
	title: "Sharper dashboard flow",
	description: "New layout is live.",
	readMore: { href: "/dashboard", label: "Open dashboard" },
} as const;

export function LatestChange({ userRole }: { userRole?: string }) {
